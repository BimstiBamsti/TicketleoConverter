...
bool Worksheet::setPageMargin(
    double top, double right, double bottom, double left, double header, double footer)
{
    Q_D(Worksheet);
...
bool Worksheet::writeHeader(const QString &value)
{
    Q_D(Worksheet);
    d->ModdHeader = value;
    return true;
...
bool Worksheet::writeFooter(const QString &value)
{
    Q_D(Worksheet);
    d->MoodFooter = value;
    return true;
